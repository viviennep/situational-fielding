...
angles,dists,wall_rad_dist,wall_ball_dist,wall_dir_dist,wall_min_dist,wall_dir_h = calc_wall_properties(of_plays)

of_plays = of_plays.with_columns(angle=angles,
                                 dist=dists,
